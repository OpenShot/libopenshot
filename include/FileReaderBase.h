...
/**
 * \file
 * \brief Header file for FileReaderBase class
...
namespace openshot
{
	 ...
	 *
	 * Each derived class of FileReaderBase is responsible for updating this struct to reflect accurate information
	...
	struct FileInfo
	{
		...
		int video_length;	///< The number of frames in the video stream
		...
		int audio_length;	///< The number of audio packets in the audio stream (this is different than fps or sample rate)
